...
const Contact = () => {
  return (
    <div name="contact" className='relative w-full flex flex-col items-center sm:pb-24 pb-12'> 
        ...
        <div className='w-full flex justify-center p-8'>
            <form method='POST' action='https://getform.io/f/d900ad56-5f1f-4771-acfb-7738d74f5459' className='sm:text-[18px] text-[14px] text-black border-[2px] font-serif p-10 bg-gray-100 flex flex-col max-w-[600px] w-full'>
